...
var input = document.querySelector('.customLook'),
    ...
    tagify = new Tagify(input, {
        ...
        // allow both emails and other inputs
        validate: function(tag){
            // email validation (https://stackoverflow.com/a/46181/104380)
            var emailRegex = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
            return emailRegex.test(tag) || tag.length > 2; // Accept emails or tags with at least 3 characters
        },
